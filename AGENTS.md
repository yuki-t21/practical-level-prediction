...
| :--- | :--- | :--- |
| `dataform/` | [dataform/AGENTS.md](dataform/AGENTS.md) | Dataform Core 3.0 準拠、SQL スタイルガイド、アサーション・ユニットテストの義務化 |
...
1. **Dataform 定義**: `dataform/definitions/sources/` 配下の `.sqlx` ファイル
...
| `SQLFluff` | SQLX (`dataform/`) | `sqlfluff lint definitions/` |
...
1. **Python 開発**: pytest パス、black/flake8 適合、パッケージバージョン固定
